...
export default class CrmOppFinancialInvceHstry extends NavigationMixin(LightningElement) {
    ...
    @track sortByName='blng__Order__r.OrderNumber desc,  Name';
    @track sortType='desc';
    ...
    @api fields='Id,Name,CustomOrderNumber__c,Invoice_Number_SFDC__c,blng__InvoiceDate__c,Invoice_Payment_Status__c,blng__Payments__c,blng__Balance__c,blng__StatusFlag__c,blng__InvoiceStatus__c,blng__DueDate__c,blng__PaymentMethod__c,blng__TotalAmount__c,LastModifiedDate,blng__Order__r.OpportunityId,blng__Order__r.Opportunity.Name';
    @api fieldsLabel='Id,Name,CustomOrderNumber__c,Invoice_Number_SFDC__c,blng__InvoiceDate__c,Invoice_Payment_Status__c,blng__Payments__c,blng__Balance__c,blng__StatusFlag__c,blng__InvoiceStatus__c,blng__DueDate__c,blng__PaymentMethod__c,blng__TotalAmount__c,LastModifiedDate,blng__Order__r.OpportunityId,blng__Order__r.Opportunity.Name';
    @api condition;
    @track tempCondition='';
    @api profile='';    
    ...
    connectedCallback(){
        ...
        this.PAYMENTSMETHOD = Payment_Method1;
    ...
    /**
     * description : This check if the Account related to Opportunity is active or not.
     */
    getAccountState(){
