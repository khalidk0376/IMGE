...
import Status_Flag from '@salesforce/label/c.Status_Flag';
import Due_Date from '@salesforce/label/c.Due_Date';
import Invoice_Processed from '@salesforce/label/c.Invoice_Processed';
import Payment_Method1 from '@salesforce/label/c.Payment_Method1';
import TOTAL_AMOUNT_WITH_TAX from '@salesforce/label/c.TOTAL_AMOUNT_WITH_TAX';
import Last_Modified_Date from '@salesforce/label/c.Last_Modified_Date';
// importing navigation service
import { NavigationMixin } from 'lightning/navigation';


export default class CrmOppFinancialFinalInvoice extends NavigationMixin(LightningElement) {
    ...
    @api objectLabel='Final Invoice';    
    @api fields='Id,Name,CustomOrderNumber__c,Invoice_Number_SFDC__c,blng__InvoiceDate__c,Invoice_Payment_Status__c,blng__Payments__c,blng__Balance__c,blng__StatusFlag__c,blng__InvoiceStatus__c,blng__DueDate__c,Invoice_Processed__c,blng__PaymentMethod__c,blng__TotalAmount__c,LastModifiedDate,blng__Account__c,OpportunityId__c';
    @api fieldsLabel='Id,Name,CustomOrderNumber__c,Invoice_Number_SFDC__c,blng__InvoiceDate__c,Invoice_Payment_Status__c,blng__Payments__c,blng__Balance__c,blng__StatusFlag__c,blng__InvoiceStatus__c,blng__DueDate__c,Invoice_Processed__c,blng__PaymentMethod__c,blng__TotalAmount__c,LastModifiedDate';
    @api condition='Id!=\'\'';
    @track tempCondition='';
    @api profile='';    
    ...
    @track LabelInvoiceDate;
    @track LabelPayments;
    @track LabelBalance;
    @track LabelStatusFlag;
    @track LabelDueDate;
    @track LabelInvoiceProcessed;
    @track LabelPaymentMethod;
    @track LabelTOTALAMOUNTWITHTAX;
    @track LabelLastModifiedDate;

    connectedCallback(){
        this.LabelInvoiceDate = Invoice_Date;
        this.LabelPayments = Payments1;
        this.LabelBalance = Balance;
        this.LabelStatusFlag = Status_Flag;
        this.LabelDueDate = Due_Date;
        this.LabelInvoiceProcessed = Invoice_Processed;
        this.LabelPaymentMethod = Payment_Method1;
        this.LabelTOTALAMOUNTWITHTAX = TOTAL_AMOUNT_WITH_TAX;
        this.LabelLastModifiedDate = Last_Modified_Date;

        if(this.showMail){
            this.sortByName='Name , LastModifiedDate'
        }
...
/**
     * description : This method will fetch the data for table.
     */
    getData(){
        this.spinner = true;
...
/**
     * description : This method will check if the Account related to opportunity is active or not.
     */
    getAccountState(){
        getRecordDetail({objectName:'Opportunity',allFields:'Account.Inactive__c',recordId:this.recordId})
        .then(res=>{
            if(res.length>0){
...
/**
     * description : This method will handle the filters.
     */
    handleFilterChange(){
    ...
    /**
     * description : This method will handle the row actions.
     */
...
/**
     * description : This method will handle the delete selected data.
     */
    yesDeleteAll() {
        var records = [];        
...
/**
     * parameter : tbldatas [data to format]
     * description : This method will format the data for table.
     */
    setParentFieldValue(tbldatas){ 
        ...
        for(let i=0;i<datas.length;i++){
            ...
            datas[i].emailLink = '/apex/sendInvoice?id='+datas[i].Id+'&retUrl='+datas[i].OpportunityId__c+'&accountId='+datas[i].blng__Account__c+'&IsAccount=true';
            //build link
    ...
    /**
     * parameter : event
     * description : This method will change the number of rows shown in table.
     */
    ...
    /**
     * description : This method will search the specific data in the table.
     */
    searchData(){        
...
/**
     *description : This method will handle sorting in the table.
     */
    handleSorting(event){
...
/**
     *description : This method will build condition to filter data for table.
     */
    buildCondition(){
