...
export default class CrmOppFinancialContract extends LightningElement {
    //action properties
    ...
    @track sortByName='ActivatedDate';
    @track sortType='desc';
    ...
    @api fields='ContractNumber,StartDate,EndDate,ActivatedDate,LastModifiedDate,SBQQ__Opportunity__r.Name';
    @api fieldsLabel='Contract Number,Contract Start Date,Contract End Date,Activated Date,Last Modified Date,Opportunity';
    @api condition;
    @track tempCondition='';
    @api profile='';    
    ...
    setParentFieldValue(tbldatas){ 
        ...
        for(let i=0;i<datas.length;i++){
            ...
            datas[i].contractLink='/lightning/r/'+this.objectName+'/'+datas[i].Id+'/view';
            //build link
