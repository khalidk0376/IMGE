...
@description : Getting user manuals and this component used on (opsExhibitorProfileReports) component.
...
export default class OpsCustomerListManualTab extends LightningElement {
    label = {manual,name,provider,type,deadline,viewed,agreed,save,close,downloadpdf,readandagree,required, manuals, additional };
    //action properties
    ...
    handleSorting(event){
        ...
        //console.log(sortFieldName+'==='+prevSortedBy + '&&' +prevSortDir+'===asc');
