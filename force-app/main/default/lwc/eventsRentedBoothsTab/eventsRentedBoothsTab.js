...
export default class EventsRentedBoothsTab extends LightningElement {
    @api mapBoothDetails;
    @track mapBoothDetailsTempVar;
    @api rentedBoothColumns;
    ...
    */
    downloadCSVFile(){
        let requiredlabels = ['AccountName','Area','Dimensions','IsRented','DisplayNameOverride','BoothNumber'];
        if(this.selectedRows){
            exportCSV(this.selectedRows,requiredlabels,'RentedBooth-export');
        } else {
            exportCSV(this.mapBoothDetails,requiredlabels,'RentedBooth-export');
        }
    }
