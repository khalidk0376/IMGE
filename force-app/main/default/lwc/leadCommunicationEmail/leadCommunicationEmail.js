...
@description : This Component is used for Lead communication Email Functionality
...
//custom label
import Communication_Group from '@salesforce/label/c.Communication_Group';
import Communication_Type_Code from '@salesforce/label/c.Communication_Type_Code';
import Value from '@salesforce/label/c.Value';

export default class LeadCommunicationEmail extends LightningElement {
    ...
    @api objectName='';
    @api objectLabel='';    
    @api fields='Communication_Group__c,Communication_Type_Code__c,Communication_Class__c,Communication_Category__c,Value__c';
    @api fieldsLabel='Communication Group,Communication Type Code,Email Type,Email Category,Value';
    @api condition='Id!=\'\'';
    @track tempCondition='';
    @api profile='';    
    ...
    @track COMMUNICATIONGROUP = Communication_Group;
    @track COMMUNICATIONTYPECODE = Communication_Type_Code;
    @track COMMUNICATIONVALUE = Value;
    ...
    setParentFieldValue(tbldatas){ 
        ...
        for(let i=0;i<datas.length;i++){
            ...
            datas[i].recordLink = '/apex/c__UpdateLeadCommunication?id='+datas[i].Id;
            //build link
