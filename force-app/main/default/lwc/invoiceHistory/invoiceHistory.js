...
export default class InvoiceHistory extends NavigationMixin(LightningElement) {
    @api recordId;
    ...
    @api fields='Name,Invoice_Number_SFDC__c,blng__InvoiceDate__c,Invoice_Payment_Status__c,blng__Payments__c,blng__Balance__c,blng__StatusFlag__c,blng__InvoiceStatus__c,blng__DueDate__c,blng__PaymentMethod__r.Name,LastModifiedDate,OpportunityId__c';
    @api fieldsLabel='Invoice Number,Sequential Number,Invoice Date,Payment Status,Payments,Balance,Status Flag,Status,Due Date,Payment Method,Last Modified Date,OpportunityId';
    @api condition='Id!=\'\'';
    @track tempCondition='';
    @api profile='';    
