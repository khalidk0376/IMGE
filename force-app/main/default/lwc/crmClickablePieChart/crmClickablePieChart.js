...
import getReportData from '@salesforce/apex/CommonTableController.getAggregateData2';
import {handleErrors,toast} from 'c/lWCUtility';
import LOCALE from '@salesforce/i18n/locale';

export default class CrmClickablePieChart extends LightningElement {
    @api
    chartDatas = [];
    ...
    renderedCallback(){
        this.config = this.getConfig('pie');
        ...
        if(this.isClickable){             
            ...
            if(activePoint){                
                ...
                if(this.newSelected!==this.prevSelected){
                    this.tempCondition = this.condition + ' AND EventEdition__r.Name=\''+this.newSelected+'\' ';
