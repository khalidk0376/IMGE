({
	...
	{
		var tarUrl = window.location.origin + '/apex/c__ExportBadgesVF?reportName=AllAgentBadges&eventId=' +component.get("v.eventId");  
        window.location =  tarUrl;
	},
	exportAgentsWithoutBadges : function(component, event, helper)   // CCEN-671
	{
		var tarUrl = window.location.origin + '/apex/c__ExportBadgesVF?reportName=AgentsWithoutBadges&eventId=' +component.get("v.eventId");  
        window.location =  tarUrl;
	},
