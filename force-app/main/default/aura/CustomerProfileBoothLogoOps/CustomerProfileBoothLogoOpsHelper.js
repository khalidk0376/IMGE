({
    ...
    fetchExistingAttach: function (component) {
        console.log('fetchExistingAttach'  );
        console.log('boothId' +component.get("v.parentId") );
    ...
    checkFile: function (component, inputFile) {
        console.log('checking file inputFile-' + inputFile);
        var fileInput = component.find("inputFile").getElement();
        var file = fileInput.files[0];
        console.log('value-' + fileInput.value);
        console.log('file.name-' + file.name); //|| file.name.indexOf('jpgqq')  || file.name.indexOf('jpeg') || file.name.indexOf('eps') || file.name.indexOf('ai')
