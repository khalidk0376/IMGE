({
	onInit: function (component, event, helper) {
		...
		component.set("v.WrapEEPCMAndchild", []);
	...
	l2EEProdCatMapgClick: function (component, event, helper) {
		//console.log('listWrapEESCMValuesANDCheckbox1 ');
		function isIE() {
		...
		//console.log('idInnerSpan-' + idInnerSpan);
		if (idInnerSpan === 'innerSpan') {
			...
			//console.log('listWrapEESCMValuesANDCheckbox ' +listWrapEESCMValuesANDCheckbox);
			/*
			isTrue="{!v.showFakeL3}">
		...
		//var ch = !!window.chrome && !!window.chrome.webstore;
		//console.log('test ================' +isFirefox);
